...
def assign(
    ...
    img_w,
    img_h,
    train_matchnet = False,
    matchnet_assign = None,
    generate_data = None,
    matchnet_batch = 18,
    ...
    if train_matchnet: 
        ...
        # generate data for matchnet training
        cost_input, lane_target, gt, lane_idx  = generate_data(
                                                ...
                                                matched_col_inds, matchnet_batch)
        return matched_row_inds, matched_col_inds, cost_input, lane_target, gt, lane_idx 

    else:
        # matchnet assign
        matched_row_inds, matched_col_inds = matchnet_assign(
                                            theta_score_deep, start_xys_score_deep, distances_score_deep,
