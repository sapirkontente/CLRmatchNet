# Section 1 matchnet
# train
matchnet_batch_size = 18
matchnet_lr = 0.0001
matchnet_pos_dist_thresh = 0.3
matchnet_neg_dist_thresh = 0.9 
fb_iou_weight = 0.1
fb_loss_thresh = 0.3
# inference 
conf_treshold = 0.6 # Denotes the minimum confidence score required in matchnet to be a positive match
